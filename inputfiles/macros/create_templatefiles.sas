  ...
  %macro create_t1t2_tablecolumns();
    ...
    *************************************;
     ...
     data tablecolumnsfile;
	   ...
	   Column = "timetocensor";                          ColumnLabel = "Time to Data End (Days)";                                                           ColumnFormat = "comma13.0"; Table = "t1cida"; CIrate = "N"; order = 21; includeinreport = 'Y'; columnwidth=.72; output; Table = "t2cida"; order = 34; includeinreport = 'N'; output;
	   ...
	   Column = "All_Events";                            ColumnLabel = "All Events";                                                                        ColumnFormat = "comma14.0"; Table = "t2cida"; CIrate = "N"; order = 31; includeinreport = 'Y'; columnwidth=.82; output; Table = "t2conc"; order = 29; output;
