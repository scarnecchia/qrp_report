    ...
    *************************************;
     ...
     data tablecolumnsfile;
       attrib Table             length = $10    format = $10.
        ...
        Table = "t1cida"; Column = "DenNumMemDays";                         ColumnLabel = "Total Eligible Member-Days";                                                                             ColumnFormat = "comma16.0";    ColumnWidth = .82;    CIrate = "N";    IncludeinReport = "Y";    Order = 4;     DefOrder = 8;    output;
        Table = "t2cida";                                                                                                                                                                                                                                                                           Order = 21;    DefOrder = 12;   output;
        Table = "t1cida"; Column = "DenNumMemDays/365.25";                  ColumnLabel = "Total Eligible Member-Years";                                                                            ColumnFormat = "comma15.1";    ColumnWidth = .82;    CIrate = "N";    IncludeinReport = "Y";    Order = 5;     DefOrder = 9;    output;
  ...
  %macro create_t4_tablecolumns();
    ...
    *************************************;
     ...
     data tempfl.t4_tablecolumnsfile_default;
	   ...
	   table = "T7"; Column = "npts";                              		ColumnLabel = "Number of Pregnant Patients";    																ColumnFormat = "comma14.0";  order = 1;  IncludeinReport = "Y"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "episodes";                          		ColumnLabel = "Number of Pregnancy Episodes";   																ColumnFormat = "comma14.0";  order = 2;  IncludeinReport = "Y"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "eps_wevents";                       		ColumnLabel = "Number of Pregnancy Episodes with an Event";     												ColumnFormat = "comma14.0";  order = 3;  IncludeinReport = "Y"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "eps_wevents/episodes";             		ColumnLabel = "Proportion of Pregnancy Episodes with an Event";             									ColumnFormat = "comma13.2";  order = 4;  IncludeinReport = "Y"; columnWidth=.9; CIrate = "N"; output;
	   ...
	   table = "T7"; Column = "followuptime/365.25";               		ColumnLabel = "Total Years at Risk";             																ColumnFormat = "comma13.1";  order = 7;  IncludeinReport = "N"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "followuptime/30.35";                     ColumnLabel = "Total Months at Risk";             																ColumnFormat = "comma13.1";  order = 8;  IncludeinReport = "N"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "followuptime/7";                         ColumnLabel = "Total Weeks at Risk";             																ColumnFormat = "comma13.1";  order = 9;  IncludeinReport = "N"; columnWidth=.9; CIrate = "N"; output;
	   ...
	   table = "T7"; Column = "timetocensor/365.25";                   	ColumnLabel = "Total Observable Years";             															ColumnFormat = "comma13.1";  order = 21; IncludeinReport = "N"; columnWidth=.9; CIrate = "N"; output;
	   table = "T7"; Column = "timetocensor";                          	ColumnLabel = "Total Observable Days";             																ColumnFormat = "comma14.0";  order = 22; IncludeinReport = "N"; columnWidth=.9; CIrate = "N"; output;
