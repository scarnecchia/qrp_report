  ...
  %macro create_tablecolumns();
    ...
    *************************************;
     ...
     data tempfl.tablecolumnsfile;
	   ...
	   Column = "timetocensor"; ColumnLabel = "Time to Data End (Days)"; ColumnFormat = "comma13.0"; Table = "t1cida"; CIrate = "N"; order = 21; includeinreport = 'N'; output; Table = "t2cida"; order = 34; output;
