	...
	data lookup_t5tablefigurefile;
		...
		%do s = 1 %to &stratlevels.;
		    ...
		    %else %do;
              ...
              levelid3 = "cfdd %sysfunc(left(%scan(%str(&stratLevel.), &s, '|')))";
		    %end;
            output;
		%end;
		dataset = "t5dose";
		%do s = 1 %to &stratlevels.;
		    ...
		    %else %do;
              ...
              levelid3 = "afdd %sysfunc(left(%scan(%str(&stratLevel.), &s, '|')))";
		    %end;
            output;
		%end;
		%do s = 1 %to &stratlevels.;
		    ...
		    %else %do;
              ...
              levelid3 = "afdd episodenum %sysfunc(left(%scan(%str(&stratLevel.), &s, '|')))";
		    %end;
            output;
		%end;
	    %do s = 1 %to &stratlevels.;
		    ...
		    %else %do;
              ...
              levelid3 = "cumdose %sysfunc(left(%scan(%str(&stratLevel.), &s, '|')))";
		    %end;
            output;
		%end;
		%do s = 1 %to &stratlevels.;
		    ...
		    %else %do;
              ...
              levelid3 = "cumdose episodenum %sysfunc(left(%scan(%str(&stratLevel.), &s, '|')))";
		    %end;
            output;
		%end;
