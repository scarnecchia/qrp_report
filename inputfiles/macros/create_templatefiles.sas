  ...
  %macro create_t1t2_tablecolumns();
    ...
    *************************************;
     ...
     data tablecolumnsfile;
	   ...
	   Column = "timetocensor";                          ColumnLabel = "Time to Data End (Days)";                                                           ColumnFormat = "comma13.0"; Table = "t1cida"; CIrate = "N"; order = 21; includeinreport = 'N'; columnwidth=.72; output; Table = "t2cida"; order = 34; output;
