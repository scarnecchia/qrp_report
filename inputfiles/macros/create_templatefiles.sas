  ...
  %macro create_tablecolumns();
    ...
    *************************************;
     ...
     data tablecolumnsfile;
	   ...
	   Column = "Npts"; ColumnLabel = "New Users"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 1; IncludeinReport = "Y"; columnwidth=.67; output; Table = "t2cida"; output; Table = "t2conc"; output;
	   ...
	   Column = "Episodes"; ColumnLabel = "New Episodes"; ColumnFormat = "comma14.0"; CIrate = "N"; Table = "t1cida"; order = 5; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 3; output; Table = "t2conc"; order = 2; output;
	   ...
	   Column = "AdjustedCodeCount"; ColumnLabel = "Adjusted Dispensings"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 8; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 4; output; Table = "t2conc"; order = 3; output;
	   ...
	   Column = "RawCodeCount"; ColumnLabel = "Raw Dispensings"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 10; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 6; output; Table = "t2conc"; order = 5; output;
	   ...
	   Column = "DaySupp"; ColumnLabel = "Days Supplied"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 12; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 8; output; Table = "t2conc"; order = 7; output;
	   ...
	   Column = "AmtSupp"; ColumnLabel = "Amount Supplied"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 17; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 13; output; Table = "t2conc"; order = 12; output;
	   ...
	   Column = "DenNumPts"; ColumnLabel = "Eligible Members"; ColumnFormat = "comma14.0"; Table = "t1cida"; CIrate = "N"; order = 22; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2cida"; order = 35; output;
	   ...
	   Column = "Eps_wEvents"; ColumnLabel = "New Episodes with an Event"; ColumnFormat = "comma14.0"; Table = "t2cida"; CIrate = "N"; order = 17; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2conc"; order = 16; output;
	   ...
	   Column = "All_Events"; ColumnLabel = "All Events"; ColumnFormat = "comma14.0"; Table = "t2cida"; CIrate = "N"; order = 31; columnwidth=.67; output; Table = "t2conc"; order = 29; includeinreport = 'Y'; output;
	   Column = "followuptime"; ColumnLabel = "Days at Risk"; ColumnFormat = "comma14.0"; Table = "t2cida"; CIrate = "N"; order = 32; includeinreport = 'Y'; columnwidth=.67; output; Table = "t2conc"; order = 30; output;
