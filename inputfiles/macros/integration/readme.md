...
### What is this?  
The integration folder will contain files required for integration with other Sentinel applications. Public users of the query request package (QRP) can ignore content found in this folder. 
