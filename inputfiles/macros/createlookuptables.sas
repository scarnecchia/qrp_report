...
****************************************************************************************************
*
* PROGRAM: createlookuptables.sas  
* Created (mm/dd/yyyy): 11/3/2020

*--------------------------------------------------------------------------------------------------
* PURPOSE: The macro creates the lookup table to map levelIDs to requested tables   
* 
*  Program inputs:                                                                                   
* 
*  Program outputs:                                                                                                                                       
