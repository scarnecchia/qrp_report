 ...
 /* Define libname for location of templatefiles folder */
  ...
  %macro create_lookup();
     data lookup.lookup_footnotes;
	  ...
	  type = "baseline";  order = 18; description = "Gagne JJ, Glynn RJ, Avorn J, Levin R, Schneeweiss S. A combined comorbidity score predicted mortality in elderly patients better than existing scores. J Clin Epidemiol. 2011;64(7):749-759. Sun JW, Rogers JR, Her Q, Welch EC, Panozzo CA, Toh S, Gagne JJ. Adaptation and validation of the combined comorbidity score for ICD-10-CM. Med Care. 2017;55(12):1046-1051."; output;
	  ...
	  type = "baseline";  order = 24; description = "Sun, J. W., Bourgeois, F. T., Haneuse, S., Hernández-Díaz, S., Landon, J. E., Bateman, B. T., Huybrechts, K. F. Development and validation of a pediatric comorbidity index. American Journal of Epidemiology. 2020;190(5):918-927."; output;
	  type = "baseline";  order = 25; description = "Pisters R, Lane DA, Nieuwlaat R, de Vos CB, Crijns HJGM, Lip GYH. A novel user-friendly score (HAS-BLED) to assess 1-year risk of major bleeding in patients with atrial fibrillation. Chest. 2010;138(5):1093-1100."; output;
	  type = "baseline";  order = 26; description = "Lip GYH, Nieuwlaat R, Pisters R, Lane DA, Crijns HJGM. Refining clinical risk stratification for predicting stroke and thromboembolism in atrial fibrillation using a novel risk factor-based approach. Chest. 2010;137(2): 263-272."; output;
	  type = "baseline";  order = 27; description = "Bateman BT, Mhyre JM, Hernandez-Diaz S, Huybrechts KF, Fischer MA, Creanga AA, Callaghan WM, Gagne JJ. Development of a comorbidity index for use in obstetric patients. Obstet Gynecol. 2013;122(5):957-965."; output;
	  type = "baseline";  order = 28; description = "Chang H-Y, Weiner JP, Richards TM, Bleich SN, Segal JB. Validating the adapted Diabetes Complications Severity Index in claims data. Am J Manag Care. 2012;18(11):721-726."; output;
	  type = "baseline";  order = 29; description = "Kim DH, Schneeweiss S, Glynn RJ, Lipsitz LA, Rockwood K, Avorn J. Measuring frailty in Medicare data: development and validation of a claims-based frailty index. J Gerontol A Biol Sci Med Sci. 2018;73(7)980-987."; output;
