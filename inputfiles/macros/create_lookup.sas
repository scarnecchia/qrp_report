 ...
 /* Define libname for location of templatefiles folder */
  ...
  %macro create_lookup();
     data lookup.lookup_footnotes;
	   ...
	   order = 1;  type = "baseline";  description = "All metrics are based on total number of episodes per group, except for sex, race, and Hispanic origin which are based on total number of unique patients."; output;
	   order = 2;  type = "baseline";  description = "&covar_characteristic. in blue show a standardized difference greater than &sdthreshold.."; output;
	   order = 3;  type = "baseline";  description = "Covariates in italics were not included in the propensity score logistic regression model."; output;
	   order = 4;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after propensity score (PS) stratum weighting and should not be interpreted as a description of the unweighted population. Treated/control patients are weighted by the proportion of the total patient population included in their PS stratum divided by the proportion of the total treated/control patient population included in their PS stratum."; output;
	   order = 5;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after propensity score (PS) stratum weighting and should not be interpreted as a description of the unweighted population. Treated patients are assigned a weight of 1, and control patients are weighted by the proportion of the total treated patient population included in their PS stratum divided by the proportion of the total control patient population included in their PS stratum."; output;
	   order = 6;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after propensity score (PS) stratification and should not be interpreted as a description of the unweighted population. Treated/control patients are weighted by the proportion of the total patient population included in their PS stratum divided by the proportion of the total treated/control patient population included in their PS stratum."; output;
	   order = 7;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after inverse probability weighting and should not be interpreted as a description of the unweighted population. Treated patients are weighted by the inverse of their propensity score (PS), while reference patients are weighted by the inverse of 1 minus their PS."; output;
	   order = 8;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after inverse probability weighting and should not be interpreted as a description of the unweighted population. Treated patients are weighted by the proportion of treated patients in the trimmed population divided by the inverse of their propensity score (PS). Reference patients are weighted by 1 minus the proportion of treated patients in the trimmed population divided by 1 minus their PS."; output;
	   order = 9;  type = "baseline";  description = "Weighted patient characteristics tables facilitate the assessment of covariate balance after inverse probability weighting and should not be interpreted as a description of the unweighted population. Treated patients are assigned a weight of 1. Reference patients are weighted by their propensity score (PS) divided by 1 minus their PS."; output;
	   order = 10; type = "baseline";  description = "With variable ratio matching, each exposed subject is matched to a variable number of comparator subjects. The weight for each treated subject equals 1. The weight for each control subject equals the inverse of the matching ratio for that specific matched set."; output;
	   order = 11; type = "baseline";  description = "Baseline period in reference to user defined index date (pregnancy start, exposure date, or delivery date)."; output;
	   order = 12; type = "baseline";  description = "Value represents the proportion of episodes with first switch."; output;
	   order = 13; type = "baseline";  description = "Value represents the proportion of first switch episodes with second switch."; output;
	   order = 14; type = "baseline";  description = "Value represents standard deviation where no % follows the value."; output;
       order = 15; type = "baseline";  description = "Race data may not be completely populated at all Data Partners; therefore, data about race may be incomplete."; output;
	   order = 16; type = "baseline";  description = "Gestational age estimated using a claims-based algorithm, previously validated in the Medication Exposure in Pregnancy Risk Evaluation Program (MEPREP), to identify pregnancies ending in a live birth. ICD-10-CM diagnosis codes indicative of weeks of gestation, and ICD-9-CM and ICD-10-CM diagnosis codes for pre-term and post-term deliveries, were used to calculate the length of the pregnancy episode. Codes had to occur within 7 days of a delivery date in the inpatient setting. In absence of pre-/post-term codes, pregnancy duration was set to 273 days."; output;
	   order = 17; type = "baseline";  description = "The Charlson/Elixhauser Combined Comorbidity Score is calculated based on comorbidities observed during a requester-defined window around the exposure episode start date. (Gagne JJ, Glynn RJ, Avorn J, Levin R, Schneeweiss S. A combined comorbidity score predicted mortality in elderly patients better than existing scores. J Clin Epidemiol. 2011;64(7):749-759)"; output;
	   
	   /* Footnotes for L2 effect estimates table */	  
	   order = 1;  type = "effectest"; description = "All values in this section are weighted."; output;
	   order = 2;  type = "effectest"; description = "Race data may not be completely populated at all Data Partners; therefore, data about race may be incomplete."; output;
	   order = 3;  type = "effectest"; description = "Delivery status based on algorithm-derived pregnancy duration."; output;
	   order = 4;  type = "effectest"; description = "&weightscheme. = &weightschemelong.."; output;

       /* Footnotes for attrition table */
	   order = 1;  type = "attrition"; description = '&claim_level_descr. can meet multiple inclusion and/or exclusion criteria; therefore, the total number of %sysfunc(lowcase(&claim_level_descr.)) excluded overall may not equal the sum of all %sysfunc(lowcase(&claim_level_descr.)) in each criterion.'; output;
	   
	   /* Footnotes for KM/CDF figures */
	   order = 1;  type = "kmcdf";     description = 'A single episode may contribute to multiple categories if a patient was censored due to multiple criteria on the same day.'; output;
	 
	   /* Footnotes for type 1, type 2 and concomitant use tables */
	   order = 1;  type = "t1t2conc";  description = "Race data may not be completely populated at all Data Partners; therefore, data about race may be incomplete."; output;
	   order = 2;  type = "t1t2conc";  description = 'Eligible Members are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 3;  type = "t1t2conc";  description = 'Eligible Member-Days are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 4;  type = "t1t2conc";  description = 'Eligible Member-Years are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 5;  type = "t1t2conc";  description = 'Eligible Member-Days and Member-Years are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 6;  type = "t1t2conc";  description = 'Eligible Members and Member-Years are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 7;  type = "t1t2conc";  description = 'Eligible Members and Member-Days are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	   order = 8;  type = "t1t2conc";  description = 'Eligible Members, Member-Days, and Member-Years are reflective of the number of patients that met all cohort entry criteria on at least one day during the query period.'; output;
	 
	   /* Footnotes for types 1, 2, and 5 censor tables */
	   order = 1;  type = "censor";    description = "An episode may be censored due to more than one reason if they occur on the same date. Therefore, the sum of the reasons for censoring may be greater than the total number of episodes."; output;
	   order = 2;  type = "censor";    description = "A patient's episode may be censored due to more than one reason if they occur on the same date. Therefore, the sum of the reasons for censoring may be greater than the total number of patients."; output;
	   order = 3;  type = "censor";    description = "Time to end of observable data is for characterization purposes only. It does not necessarily represent at-risk time, and does not consider episode end, outcome occurrence, blackout period, or delay risk period start."; output;
	   order = 4;  type = "censor";    description = "Represents episodes censored due to end of the exposure episode. In as-treated analyses, exposure episodes are defined using days supplied as recorded in outpatient pharmacy dispensing records, and episodes end after days supplied are exhausted or a pre-determined maximum episode duration is met. In point exposure analyses, exposure episodes end when a pre-determined maximum episode duration is met."; output;
	   order = 5;  type = "censor";    description = "Represents episodes censored due to occurrence of request-defined event."; output;
	   order = 6;  type = "censor";    description = "Represents episodes censored due to occurrence of additional user-defined criteria using drug, procedure, diagnosis, and/or laboratory codes."; output;
	   order = 7;  type = "censor";    description = "Represents episodes censored due to evidence of death. Death data source and completeness varies by Data Partner."; output;
	   order = 8;  type = "censor";    description = 'Represents episodes censored due to disenrollment from health plan. Data Partners often artificially assign a ""disenrollment"" date equal to data end date for members still enrolled on that date. Therefore, a patient may have dual reasons for censoring as ""disenrollment"" and ""end of data"" on the same day - this can be interpreted as right-censoring in most cases.'; output;
	   order = 9;  type = "censor";    description = "Represents episodes censored due to Data Partner data end date. This end date represents the last day of the most recent year-month in which all of a Data Partner's data tables in the Sentinel Common Data Model have at least 80% of the record count relative to the prior month."; output;
	   order = 10; type = "censor";    description = "Represents episodes censored due to user-specified study end date."; output;
	   order = 11; type = "censor";    description = "Represents episodes censored due to occurrence of first switch."; output;
	   order = 12; type = "censor";    description = "Represents episodes censored due to occurrence of second switch."; output;
	 run; 
