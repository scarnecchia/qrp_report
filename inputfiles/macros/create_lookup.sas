  ...
  %macro create_lookup();
     data lookup.lookup_footnotes;
      ...
      type = "baseline";  order = 16; description = 'Includes members classified as having an unknown race by the Data Partner and patients in race categories where the total member count is between one and ten.'; output;
	   ...
	   type = "baseline";  order = 18; description = "Gagne JJ, Glynn RJ, Avorn J, Levin R, Schneeweiss S. A combined comorbidity score predicted mortality in elderly patients better than existing scores. J Clin Epidemiol. 2011;64(7):749-"; output;
