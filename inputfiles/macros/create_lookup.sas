 ...
 /* Define libname for location of templatefiles folder */
  ...
  %macro create_lookup();
     data lookup.lookup_footnotes_baseline;
	   ...
	   order = 2;  description = "&covar_characteristic. in blue show a standardized difference greater than &sdthreshold.."; output;
	   ...
	   order = 12; description = "Value represents the proportion of episodes with first switch."; output;
	   order = 13; description = "Value represents the proportion of first switch episodes with second switch."; output;
